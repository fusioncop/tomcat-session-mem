 ...
 */
public class JavolutionSessionTranscoder extends SerializingTranscoder {

    static final String REFERENCE_ATTRIBUTE_ID = "__id";
    static final String REFERENCE_ATTRIBUTE_REF_ID = "__ref";

    private static final Log LOG = LogFactory.getLog( JavolutionSessionTranscoder.class );
     ...
     *            the manager
     */
    public JavolutionSessionTranscoder( final Manager manager ) {
        this( manager, false );
    }
     ...
     */
    public JavolutionSessionTranscoder( final Manager manager, final boolean copyCollectionsForSerialization,
